# Fire Spirit - Card Specification

## Basic Info
- **Card ID**: 26000011 (example)
- **Name**: Fire Spirit
- **Rarity**: Common
...
| Deploy Time | 1 sec |
| Target | Ground only |
| Mechanic | Jumps to target, explodes on death/hit (2.5 tile radius) |

## Mechanics

1. Jumps to target, explodes on death/hit (2.5 tile radius)
...
- **Sprite**: Fire Spirit character/model
...
```csharp
public class FireSpirit : MeleeTroop
{
