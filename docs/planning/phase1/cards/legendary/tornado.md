# Tornado - Card Specification

## Basic Info
- **Card ID**: 26000038 (example)
- **Name**: Tornado
- **Rarity**: Legendary
- **Type**: Spell
- **Elixir Cost**: 3
...
| Radius | 5.5 tiles |
| Duration | 1.5 sec |
| Mechanic | Pulls units to center, activates King Tower |

## Mechanics

1. Pulls units to center, activates King Tower
...
- **Sprite**: Tornado character/model
