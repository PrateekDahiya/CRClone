        ...
        private static NetworkMessage DeserializeByTypeName(string typeName, byte[] data)
        {
            using (var ms = new MemoryStream(data))
            {
                switch (typeName)
                {
                    ...
                    case "clan": return Serializer.Deserialize<ClanMessage>(ms);
                    case "clan_response": return Serializer.Deserialize<ClanResponseMessage>(ms);
                    case "shop": return Serializer.Deserialize<ShopMessage>(ms);
                    case "shop_response": return Serializer.Deserialize<ShopResponseMessage>(ms);
                    case "quest": return Serializer.Deserialize<QuestMessage>(ms);
                    case "quest_response": return Serializer.Deserialize<QuestResponseMessage>(ms);
                    case "season": return Serializer.Deserialize<SeasonMessage>(ms);
                    case "season_response": return Serializer.Deserialize<SeasonResponseMessage>(ms);
                    case "tournament": return Serializer.Deserialize<TournamentMessage>(ms);
                    case "tournament_response": return Serializer.Deserialize<TournamentResponseMessage>(ms);
                    case "replay": return Serializer.Deserialize<ReplayMessage>(ms);
                    case "replay_response": return Serializer.Deserialize<ReplayResponseMessage>(ms);
                    case "player": return Serializer.Deserialize<PlayerMessage>(ms);
                    case "player_response": return Serializer.Deserialize<PlayerResponseMessage>(ms);
                    default:
